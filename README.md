...
**Design stage, with prototypes planned.** This repository contains the product requirements and implementation design. There is no runnable application, generated appliance image, or hardware qualification result yet. Installation, launch, and test commands will accompany the implementation.
