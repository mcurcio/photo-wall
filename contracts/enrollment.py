...
Persistence = Literal["durable", "volatile"]
...
def enrollment_message(nonce: str, outputs: tuple[OutputReport, ...], persistence: Persistence = "durable") -> bytes:
    return json.dumps({"purpose": "photo-wall-enroll-v1", "nonce": nonce,
                       "outputs": [o.model_dump() for o in outputs], "persistence": persistence},
