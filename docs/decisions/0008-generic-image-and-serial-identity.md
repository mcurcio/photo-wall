...
5. **Netboot tier (D1):** re-freeze `Release` to five fields and decouple config ([contracts/release.py](../../contracts/release.py), `appliance/updates.py`, `central/releases.py`); register a five-field release and `set_default`.
