...
- [2026-09-05 CI cache checks](2026-09-05-ci-cache.md): verified container dependency-layer reuse and Linux metadata-preserving base cache; hosted cold/warm timing comparison pending.
