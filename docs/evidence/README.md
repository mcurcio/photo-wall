...
- [2026-09-05 GitHub image build](2026-09-05-github-image.md): hosted signed images built and booted; diagnostics identified a missing Player runtime directory, now corrected and checked before assembly. Corrected-image boot qualification remains pending.
