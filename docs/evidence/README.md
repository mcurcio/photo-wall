...
- [2026-09-05 GitHub image build](2026-09-05-github-image.md): hosted signed images passed generic-VM enrollment, power-cycle identity continuity and central rejoin; the third hosted pass at run 34023366287 records the exact source/component hashes, downloadable image and e2e artifacts, and 9m18s cached assembly versus 22m33s cold. Standard checks at `afff7b1` passed 842 tests / 56 explicit skips / 4 warnings plus 55 pinned Linux media tests. Its native-trial image is boot-testing; redundant demo-only image run 34024871863 was canceled. Physical/native/rollback qualification remains pending.
...
- [2026-09-06 VM rollback preparation](2026-09-06-vm-rollback.md): 924 local regression tests and 160 final focused checks, bounded independent reviews and actual Linux module/option probes; the four-boot signed candidate/recovery gate still requires hosted execution.
