...
| 18 | H-refresh (guidance banner + snapshot clock + cadence) | closed | PEND18 | M7 |
...
| residual: conftest-evidence | repoint tests/browser/conftest.py CHECKS at re-hosted console tests (or retire) | in_progress | — | acceptance-evidence artifact reports incomplete post-cutover |
